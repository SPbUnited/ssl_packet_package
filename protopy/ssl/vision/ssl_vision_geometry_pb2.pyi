...
class _SSL_FieldShapeTypeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_SSL_FieldShapeType.ValueType], builtins.type):
    ...
    Undefined: _SSL_FieldShapeType.ValueType
    CenterCircle: _SSL_FieldShapeType.ValueType
    TopTouchLine: _SSL_FieldShapeType.ValueType
    BottomTouchLine: _SSL_FieldShapeType.ValueType
    LeftGoalLine: _SSL_FieldShapeType.ValueType
    RightGoalLine: _SSL_FieldShapeType.ValueType
    HalfwayLine: _SSL_FieldShapeType.ValueType
    CenterLine: _SSL_FieldShapeType.ValueType
    LeftPenaltyStretch: _SSL_FieldShapeType.ValueType
    RightPenaltyStretch: _SSL_FieldShapeType.ValueType
    LeftFieldLeftPenaltyStretch: _SSL_FieldShapeType.ValueType
    LeftFieldRightPenaltyStretch: _SSL_FieldShapeType.ValueType
    RightFieldLeftPenaltyStretch: _SSL_FieldShapeType.ValueType
    RightFieldRightPenaltyStretch: _SSL_FieldShapeType.ValueType

class SSL_FieldShapeType(_SSL_FieldShapeType, metaclass=_SSL_FieldShapeTypeEnumTypeWrapper):
    ...
Undefined: SSL_FieldShapeType.ValueType
CenterCircle: SSL_FieldShapeType.ValueType
TopTouchLine: SSL_FieldShapeType.ValueType
BottomTouchLine: SSL_FieldShapeType.ValueType
LeftGoalLine: SSL_FieldShapeType.ValueType
RightGoalLine: SSL_FieldShapeType.ValueType
HalfwayLine: SSL_FieldShapeType.ValueType
CenterLine: SSL_FieldShapeType.ValueType
LeftPenaltyStretch: SSL_FieldShapeType.ValueType
RightPenaltyStretch: SSL_FieldShapeType.ValueType
LeftFieldLeftPenaltyStretch: SSL_FieldShapeType.ValueType
LeftFieldRightPenaltyStretch: SSL_FieldShapeType.ValueType
RightFieldLeftPenaltyStretch: SSL_FieldShapeType.ValueType
RightFieldRightPenaltyStretch: SSL_FieldShapeType.ValueType
...
class SSL_FieldLineSegment(google.protobuf.message.Message):
    ...
    def __init__(self, *, name: builtins.str | None=..., p1: global___Vector2f | None=..., p2: global___Vector2f | None=..., thickness: builtins.float | None=..., type: global___SSL_FieldShapeType.ValueType | None=...) -> None:
        ...

    def HasField(self, field_name: typing.Literal['name', b'name', 'p1', b'p1', 'p2', b'p2', 'thickness', b'thickness', 'type', b'type']) -> builtins.bool:
        ...

    def ClearField(self, field_name: typing.Literal['name', b'name', 'p1', b'p1', 'p2', b'p2', 'thickness', b'thickness', 'type', b'type']) -> None:
        ...
...
class SSL_FieldCircularArc(google.protobuf.message.Message):
    ...
    def __init__(self, *, name: builtins.str | None=..., center: global___Vector2f | None=..., radius: builtins.float | None=..., a1: builtins.float | None=..., a2: builtins.float | None=..., thickness: builtins.float | None=..., type: global___SSL_FieldShapeType.ValueType | None=...) -> None:
        ...

    def HasField(self, field_name: typing.Literal['a1', b'a1', 'a2', b'a2', 'center', b'center', 'name', b'name', 'radius', b'radius', 'thickness', b'thickness', 'type', b'type']) -> builtins.bool:
        ...

    def ClearField(self, field_name: typing.Literal['a1', b'a1', 'a2', b'a2', 'center', b'center', 'name', b'name', 'radius', b'radius', 'thickness', b'thickness', 'type', b'type']) -> None:
        ...
...
class SSL_GeometryFieldSize(google.protobuf.message.Message):
    ...
    def __init__(self, *, field_length: builtins.int | None=..., field_width: builtins.int | None=..., goal_width: builtins.int | None=..., goal_depth: builtins.int | None=..., boundary_width: builtins.int | None=..., field_lines: collections.abc.Iterable[global___SSL_FieldLineSegment] | None=..., field_arcs: collections.abc.Iterable[global___SSL_FieldCircularArc] | None=..., penalty_area_depth: builtins.int | None=..., penalty_area_width: builtins.int | None=..., center_circle_radius: builtins.int | None=..., line_thickness: builtins.int | None=..., goal_center_to_penalty_mark: builtins.int | None=..., goal_height: builtins.int | None=..., ball_radius: builtins.float | None=..., max_robot_radius: builtins.float | None=...) -> None:
        ...

    def HasField(self, field_name: typing.Literal['ball_radius', b'ball_radius', 'boundary_width', b'boundary_width', 'center_circle_radius', b'center_circle_radius', 'field_length', b'field_length', 'field_width', b'field_width', 'goal_center_to_penalty_mark', b'goal_center_to_penalty_mark', 'goal_depth', b'goal_depth', 'goal_height', b'goal_height', 'goal_width', b'goal_width', 'line_thickness', b'line_thickness', 'max_robot_radius', b'max_robot_radius', 'penalty_area_depth', b'penalty_area_depth', 'penalty_area_width', b'penalty_area_width']) -> builtins.bool:
        ...

    def ClearField(self, field_name: typing.Literal['ball_radius', b'ball_radius', 'boundary_width', b'boundary_width', 'center_circle_radius', b'center_circle_radius', 'field_arcs', b'field_arcs', 'field_length', b'field_length', 'field_lines', b'field_lines', 'field_width', b'field_width', 'goal_center_to_penalty_mark', b'goal_center_to_penalty_mark', 'goal_depth', b'goal_depth', 'goal_height', b'goal_height', 'goal_width', b'goal_width', 'line_thickness', b'line_thickness', 'max_robot_radius', b'max_robot_radius', 'penalty_area_depth', b'penalty_area_depth', 'penalty_area_width', b'penalty_area_width']) -> None:
        ...
...
class SSL_BallModelStraightTwoPhase(google.protobuf.message.Message):
    ...
    def __init__(self, *, acc_slide: builtins.float | None=..., acc_roll: builtins.float | None=..., k_switch: builtins.float | None=...) -> None:
        ...

    def HasField(self, field_name: typing.Literal['acc_roll', b'acc_roll', 'acc_slide', b'acc_slide', 'k_switch', b'k_switch']) -> builtins.bool:
        ...

    def ClearField(self, field_name: typing.Literal['acc_roll', b'acc_roll', 'acc_slide', b'acc_slide', 'k_switch', b'k_switch']) -> None:
        ...
...
class SSL_BallModelChipFixedLoss(google.protobuf.message.Message):
    ...
    def __init__(self, *, damping_xy_first_hop: builtins.float | None=..., damping_xy_other_hops: builtins.float | None=..., damping_z: builtins.float | None=...) -> None:
        ...

    def HasField(self, field_name: typing.Literal['damping_xy_first_hop', b'damping_xy_first_hop', 'damping_xy_other_hops', b'damping_xy_other_hops', 'damping_z', b'damping_z']) -> builtins.bool:
        ...

    def ClearField(self, field_name: typing.Literal['damping_xy_first_hop', b'damping_xy_first_hop', 'damping_xy_other_hops', b'damping_xy_other_hops', 'damping_z', b'damping_z']) -> None:
        ...
...
class SSL_GeometryModels(google.protobuf.message.Message):
    ...
    def __init__(self, *, straight_two_phase: global___SSL_BallModelStraightTwoPhase | None=..., chip_fixed_loss: global___SSL_BallModelChipFixedLoss | None=...) -> None:
        ...

    def HasField(self, field_name: typing.Literal['chip_fixed_loss', b'chip_fixed_loss', 'straight_two_phase', b'straight_two_phase']) -> builtins.bool:
        ...

    def ClearField(self, field_name: typing.Literal['chip_fixed_loss', b'chip_fixed_loss', 'straight_two_phase', b'straight_two_phase']) -> None:
        ...
...
class SSL_GeometryData(google.protobuf.message.Message):
    ...
    def __init__(self, *, field: global___SSL_GeometryFieldSize | None=..., calib: collections.abc.Iterable[global___SSL_GeometryCameraCalibration] | None=..., models: global___SSL_GeometryModels | None=...) -> None:
        ...

    def HasField(self, field_name: typing.Literal['field', b'field', 'models', b'models']) -> builtins.bool:
        ...

    def ClearField(self, field_name: typing.Literal['calib', b'calib', 'field', b'field', 'models', b'models']) -> None:
        ...
