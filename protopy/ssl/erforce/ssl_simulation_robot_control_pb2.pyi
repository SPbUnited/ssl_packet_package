...
class RobotCommand(google.protobuf.message.Message):
    ...
    def __init__(self, *, id: builtins.int | None=..., move_command: global___RobotMoveCommand | None=..., kick_speed: builtins.float | None=..., kick_angle: builtins.float | None=..., dribbler_speed: builtins.float | None=...) -> None:
        ...

    def HasField(self, field_name: typing.Literal['dribbler_speed', b'dribbler_speed', 'id', b'id', 'kick_angle', b'kick_angle', 'kick_speed', b'kick_speed', 'move_command', b'move_command']) -> builtins.bool:
        ...

    def ClearField(self, field_name: typing.Literal['dribbler_speed', b'dribbler_speed', 'id', b'id', 'kick_angle', b'kick_angle', 'kick_speed', b'kick_speed', 'move_command', b'move_command']) -> None:
        ...
...
class RobotMoveCommand(google.protobuf.message.Message):
    ...
    def __init__(self, *, wheel_velocity: global___MoveWheelVelocity | None=..., local_velocity: global___MoveLocalVelocity | None=..., global_velocity: global___MoveGlobalVelocity | None=...) -> None:
        ...

    def HasField(self, field_name: typing.Literal['command', b'command', 'global_velocity', b'global_velocity', 'local_velocity', b'local_velocity', 'wheel_velocity', b'wheel_velocity']) -> builtins.bool:
        ...

    def ClearField(self, field_name: typing.Literal['command', b'command', 'global_velocity', b'global_velocity', 'local_velocity', b'local_velocity', 'wheel_velocity', b'wheel_velocity']) -> None:
        ...

    def WhichOneof(self, oneof_group: typing.Literal['command', b'command']) -> typing.Literal['wheel_velocity', 'local_velocity', 'global_velocity'] | None:
        ...
...
class MoveWheelVelocity(google.protobuf.message.Message):
    ...
    def __init__(self, *, front_right: builtins.float | None=..., back_right: builtins.float | None=..., back_left: builtins.float | None=..., front_left: builtins.float | None=...) -> None:
        ...

    def HasField(self, field_name: typing.Literal['back_left', b'back_left', 'back_right', b'back_right', 'front_left', b'front_left', 'front_right', b'front_right']) -> builtins.bool:
        ...

    def ClearField(self, field_name: typing.Literal['back_left', b'back_left', 'back_right', b'back_right', 'front_left', b'front_left', 'front_right', b'front_right']) -> None:
        ...
...
class MoveLocalVelocity(google.protobuf.message.Message):
    ...
    def __init__(self, *, forward: builtins.float | None=..., left: builtins.float | None=..., angular: builtins.float | None=...) -> None:
        ...

    def HasField(self, field_name: typing.Literal['angular', b'angular', 'forward', b'forward', 'left', b'left']) -> builtins.bool:
        ...

    def ClearField(self, field_name: typing.Literal['angular', b'angular', 'forward', b'forward', 'left', b'left']) -> None:
        ...
...
class MoveGlobalVelocity(google.protobuf.message.Message):
    ...
    def __init__(self, *, x: builtins.float | None=..., y: builtins.float | None=..., angular: builtins.float | None=...) -> None:
        ...

    def HasField(self, field_name: typing.Literal['angular', b'angular', 'x', b'x', 'y', b'y']) -> builtins.bool:
        ...

    def ClearField(self, field_name: typing.Literal['angular', b'angular', 'x', b'x', 'y', b'y']) -> None:
        ...
...
class RobotControl(google.protobuf.message.Message):
    ...
    def __init__(self, *, robot_commands: collections.abc.Iterable[global___RobotCommand] | None=...) -> None:
        ...

    def ClearField(self, field_name: typing.Literal['robot_commands', b'robot_commands']) -> None:
        ...
