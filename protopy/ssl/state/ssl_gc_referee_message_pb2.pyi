...
class _MatchTypeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_MatchType.ValueType], builtins.type):
    ...
    UNKNOWN_MATCH: _MatchType.ValueType
    'not set'
    GROUP_PHASE: _MatchType.ValueType
    'match is part of the group phase'
    ELIMINATION_PHASE: _MatchType.ValueType
    'match is part of the elimination phase'
    FRIENDLY: _MatchType.ValueType
...
UNKNOWN_MATCH: MatchType.ValueType
'not set'
GROUP_PHASE: MatchType.ValueType
'match is part of the group phase'
ELIMINATION_PHASE: MatchType.ValueType
'match is part of the elimination phase'
FRIENDLY: MatchType.ValueType
'a friendly match, not part of a tournament'
...
class _HullColorEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_HullColor.ValueType], builtins.type):
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
    HULL_COLOR_UNKNOWN: _HullColor.ValueType
    'not set'
    HULL_COLOR_DARK: _HullColor.ValueType
    'dark hull color'
    HULL_COLOR_LIGHT: _HullColor.ValueType
    'light hull color'

class HullColor(_HullColor, metaclass=_HullColorEnumTypeWrapper):
    """HullColor is the color of the hull of the robots of a team"""
HULL_COLOR_UNKNOWN: HullColor.ValueType
'not set'
HULL_COLOR_DARK: HullColor.ValueType
'dark hull color'
HULL_COLOR_LIGHT: HullColor.ValueType
'light hull color'
global___HullColor = HullColor
...
class Referee(google.protobuf.message.Message):
    ...
    class _StageEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[Referee._Stage.ValueType], builtins.type):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
        NORMAL_FIRST_HALF_PRE: Referee._Stage.ValueType
        'The first half is about to start.\n        A kickoff is called within this stage.\n        This stage ends with the NORMAL_START.\n        '
        NORMAL_FIRST_HALF: Referee._Stage.ValueType
        'The first half of the normal game, before half time.'
        NORMAL_HALF_TIME: Referee._Stage.ValueType
        'Half time between first and second halves.'
        NORMAL_SECOND_HALF_PRE: Referee._Stage.ValueType
        'The second half is about to start.\n        A kickoff is called within this stage.\n        This stage ends with the NORMAL_START.\n        '
        NORMAL_SECOND_HALF: Referee._Stage.ValueType
        'The second half of the normal game, after half time.'
        EXTRA_TIME_BREAK: Referee._Stage.ValueType
        'The break before extra time.'
        EXTRA_FIRST_HALF_PRE: Referee._Stage.ValueType
        'The first half of extra time is about to start.\n        A kickoff is called within this stage.\n        This stage ends with the NORMAL_START.\n        '
        EXTRA_FIRST_HALF: Referee._Stage.ValueType
        'The first half of extra time.'
        EXTRA_HALF_TIME: Referee._Stage.ValueType
        'Half time between first and second extra halves.'
        EXTRA_SECOND_HALF_PRE: Referee._Stage.ValueType
        'The second half of extra time is about to start.\n        A kickoff is called within this stage.\n        This stage ends with the NORMAL_START.\n        '
        EXTRA_SECOND_HALF: Referee._Stage.ValueType
        'The second half of extra time.'
        PENALTY_SHOOTOUT_BREAK: Referee._Stage.ValueType
        'The break before penalty shootout.'
        PENALTY_SHOOTOUT: Referee._Stage.ValueType
        'The penalty shootout.'
        POST_GAME: Referee._Stage.ValueType
        'The game is over.'

    class Stage(_Stage, metaclass=_StageEnumTypeWrapper):
        """These are the "coarse" stages of the game."""
    NORMAL_FIRST_HALF_PRE: Referee.Stage.ValueType
    'The first half is about to start.\n    A kickoff is called within this stage.\n    This stage ends with the NORMAL_START.\n    '
    NORMAL_FIRST_HALF: Referee.Stage.ValueType
    'The first half of the normal game, before half time.'
    NORMAL_HALF_TIME: Referee.Stage.ValueType
    'Half time between first and second halves.'
    NORMAL_SECOND_HALF_PRE: Referee.Stage.ValueType
    'The second half is about to start.\n    A kickoff is called within this stage.\n    This stage ends with the NORMAL_START.\n    '
    NORMAL_SECOND_HALF: Referee.Stage.ValueType
    'The second half of the normal game, after half time.'
    EXTRA_TIME_BREAK: Referee.Stage.ValueType
    'The break before extra time.'
    EXTRA_FIRST_HALF_PRE: Referee.Stage.ValueType
    'The first half of extra time is about to start.\n    A kickoff is called within this stage.\n    This stage ends with the NORMAL_START.\n    '
    EXTRA_FIRST_HALF: Referee.Stage.ValueType
    'The first half of extra time.'
    EXTRA_HALF_TIME: Referee.Stage.ValueType
    'Half time between first and second extra halves.'
    EXTRA_SECOND_HALF_PRE: Referee.Stage.ValueType
    'The second half of extra time is about to start.\n    A kickoff is called within this stage.\n    This stage ends with the NORMAL_START.\n    '
    EXTRA_SECOND_HALF: Referee.Stage.ValueType
    'The second half of extra time.'
    PENALTY_SHOOTOUT_BREAK: Referee.Stage.ValueType
    'The break before penalty shootout.'
    PENALTY_SHOOTOUT: Referee.Stage.ValueType
    'The penalty shootout.'
    POST_GAME: Referee.Stage.ValueType
    'The game is over.'
    ...
    class _CommandEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[Referee._Command.ValueType], builtins.type):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
        HALT: Referee._Command.ValueType
        'All robots should completely stop moving.'
        STOP: Referee._Command.ValueType
        'Robots must keep 50 cm from the ball.'
        NORMAL_START: Referee._Command.ValueType
        'A prepared kickoff or penalty may now be taken.'
        FORCE_START: Referee._Command.ValueType
        'The ball is dropped and free for either team.'
        PREPARE_KICKOFF_YELLOW: Referee._Command.ValueType
        'The yellow team may move into kickoff position.'
        PREPARE_KICKOFF_BLUE: Referee._Command.ValueType
        'The blue team may move into kickoff position.'
        PREPARE_PENALTY_YELLOW: Referee._Command.ValueType
        'The yellow team may move into penalty position.'
        PREPARE_PENALTY_BLUE: Referee._Command.ValueType
        'The blue team may move into penalty position.'
        DIRECT_FREE_YELLOW: Referee._Command.ValueType
        'The yellow team may take a direct free kick.'
        DIRECT_FREE_BLUE: Referee._Command.ValueType
        'The blue team may take a direct free kick.'
        INDIRECT_FREE_YELLOW: Referee._Command.ValueType
        'The yellow team may take an indirect free kick.'
        INDIRECT_FREE_BLUE: Referee._Command.ValueType
        'The blue team may take an indirect free kick.'
        TIMEOUT_YELLOW: Referee._Command.ValueType
        'The yellow team is currently in a timeout.'
        TIMEOUT_BLUE: Referee._Command.ValueType
        'The blue team is currently in a timeout.'
        GOAL_YELLOW: Referee._Command.ValueType
        'The yellow team just scored a goal.\n        For information only.\n        Deprecated: Use the score field from the team infos instead. That way, you can also detect revoked goals.\n        '
        GOAL_BLUE: Referee._Command.ValueType
        'The blue team just scored a goal. See also GOAL_YELLOW.'
        BALL_PLACEMENT_YELLOW: Referee._Command.ValueType
        'Equivalent to STOP, but the yellow team must pick up the ball and\n        drop it in the Designated Position.\n        '
        BALL_PLACEMENT_BLUE: Referee._Command.ValueType
        'Equivalent to STOP, but the blue team must pick up the ball and drop\n        it in the Designated Position.\n        '

    class Command(_Command, metaclass=_CommandEnumTypeWrapper):
        """These are the "fine" states of play on the field."""
    HALT: Referee.Command.ValueType
    'All robots should completely stop moving.'
    STOP: Referee.Command.ValueType
    'Robots must keep 50 cm from the ball.'
    NORMAL_START: Referee.Command.ValueType
    'A prepared kickoff or penalty may now be taken.'
    FORCE_START: Referee.Command.ValueType
    'The ball is dropped and free for either team.'
    PREPARE_KICKOFF_YELLOW: Referee.Command.ValueType
    'The yellow team may move into kickoff position.'
    PREPARE_KICKOFF_BLUE: Referee.Command.ValueType
    'The blue team may move into kickoff position.'
    PREPARE_PENALTY_YELLOW: Referee.Command.ValueType
    'The yellow team may move into penalty position.'
    PREPARE_PENALTY_BLUE: Referee.Command.ValueType
    'The blue team may move into penalty position.'
    DIRECT_FREE_YELLOW: Referee.Command.ValueType
    'The yellow team may take a direct free kick.'
    DIRECT_FREE_BLUE: Referee.Command.ValueType
    'The blue team may take a direct free kick.'
    INDIRECT_FREE_YELLOW: Referee.Command.ValueType
    'The yellow team may take an indirect free kick.'
    INDIRECT_FREE_BLUE: Referee.Command.ValueType
    'The blue team may take an indirect free kick.'
    TIMEOUT_YELLOW: Referee.Command.ValueType
    'The yellow team is currently in a timeout.'
    TIMEOUT_BLUE: Referee.Command.ValueType
    'The blue team is currently in a timeout.'
    GOAL_YELLOW: Referee.Command.ValueType
    'The yellow team just scored a goal.\n    For information only.\n    Deprecated: Use the score field from the team infos instead. That way, you can also detect revoked goals.\n    '
    GOAL_BLUE: Referee.Command.ValueType
    'The blue team just scored a goal. See also GOAL_YELLOW.'
    BALL_PLACEMENT_YELLOW: Referee.Command.ValueType
    'Equivalent to STOP, but the yellow team must pick up the ball and\n    drop it in the Designated Position.\n    '
    BALL_PLACEMENT_BLUE: Referee.Command.ValueType
    'Equivalent to STOP, but the blue team must pick up the ball and drop\n    it in the Designated Position.\n    '
    ...
    class TeamInfo(google.protobuf.message.Message):
        ...
        bot_substitution_time_left: builtins.int
        'The number of microseconds left for current bot substitution'
        hull_color: global___HullColor.ValueType
        ...
        def __init__(self, *, name: builtins.str | None=..., score: builtins.int | None=..., red_cards: builtins.int | None=..., yellow_card_times: collections.abc.Iterable[builtins.int] | None=..., yellow_cards: builtins.int | None=..., timeouts: builtins.int | None=..., timeout_time: builtins.int | None=..., goalkeeper: builtins.int | None=..., foul_counter: builtins.int | None=..., ball_placement_failures: builtins.int | None=..., can_place_ball: builtins.bool | None=..., max_allowed_bots: builtins.int | None=..., bot_substitution_intent: builtins.bool | None=..., ball_placement_failures_reached: builtins.bool | None=..., bot_substitution_allowed: builtins.bool | None=..., bot_substitutions_left: builtins.int | None=..., bot_substitution_time_left: builtins.int | None=..., hull_color: global___HullColor.ValueType | None=...) -> None:
            ...

        def HasField(self, field_name: typing.Literal['ball_placement_failures', b'ball_placement_failures', 'ball_placement_failures_reached', b'ball_placement_failures_reached', 'bot_substitution_allowed', b'bot_substitution_allowed', 'bot_substitution_intent', b'bot_substitution_intent', 'bot_substitution_time_left', b'bot_substitution_time_left', 'bot_substitutions_left', b'bot_substitutions_left', 'can_place_ball', b'can_place_ball', 'foul_counter', b'foul_counter', 'goalkeeper', b'goalkeeper', 'hull_color', b'hull_color', 'max_allowed_bots', b'max_allowed_bots', 'name', b'name', 'red_cards', b'red_cards', 'score', b'score', 'timeout_time', b'timeout_time', 'timeouts', b'timeouts', 'yellow_cards', b'yellow_cards']) -> builtins.bool:
            ...
    ...
    def __init__(self, *, source_identifier: builtins.str | None=..., match_type: global___MatchType.ValueType | None=..., packet_timestamp: builtins.int | None=..., stage: global___Referee.Stage.ValueType | None=..., stage_time_left: builtins.int | None=..., command: global___Referee.Command.ValueType | None=..., command_counter: builtins.int | None=..., command_timestamp: builtins.int | None=..., yellow: global___Referee.TeamInfo | None=..., blue: global___Referee.TeamInfo | None=..., designated_position: global___Referee.Point | None=..., blue_team_on_positive_half: builtins.bool | None=..., next_command: global___Referee.Command.ValueType | None=..., game_events: collections.abc.Iterable[state.ssl_gc_game_event_pb2.GameEvent] | None=..., game_event_proposals: collections.abc.Iterable[global___GameEventProposalGroup] | None=..., current_action_time_remaining: builtins.int | None=..., status_message: builtins.str | None=...) -> None:
        ...

    def HasField(self, field_name: typing.Literal['blue', b'blue', 'blue_team_on_positive_half', b'blue_team_on_positive_half', 'command', b'command', 'command_counter', b'command_counter', 'command_timestamp', b'command_timestamp', 'current_action_time_remaining', b'current_action_time_remaining', 'designated_position', b'designated_position', 'match_type', b'match_type', 'next_command', b'next_command', 'packet_timestamp', b'packet_timestamp', 'source_identifier', b'source_identifier', 'stage', b'stage', 'stage_time_left', b'stage_time_left', 'status_message', b'status_message', 'yellow', b'yellow']) -> builtins.bool:
        ...

    def ClearField(self, field_name: typing.Literal['blue', b'blue', 'blue_team_on_positive_half', b'blue_team_on_positive_half', 'command', b'command', 'command_counter', b'command_counter', 'command_timestamp', b'command_timestamp', 'current_action_time_remaining', b'current_action_time_remaining', 'designated_position', b'designated_position', 'game_event_proposals', b'game_event_proposals', 'game_events', b'game_events', 'match_type', b'match_type', 'next_command', b'next_command', 'packet_timestamp', b'packet_timestamp', 'source_identifier', b'source_identifier', 'stage', b'stage', 'stage_time_left', b'stage_time_left', 'status_message', b'status_message', 'yellow', b'yellow']) -> None:
        ...
...
class GameEventProposalGroup(google.protobuf.message.Message):
    ...
    def __init__(self, *, id: builtins.str | None=..., game_events: collections.abc.Iterable[state.ssl_gc_game_event_pb2.GameEvent] | None=..., accepted: builtins.bool | None=...) -> None:
        ...

    def HasField(self, field_name: typing.Literal['accepted', b'accepted', 'id', b'id']) -> builtins.bool:
        ...

    def ClearField(self, field_name: typing.Literal['accepted', b'accepted', 'game_events', b'game_events', 'id', b'id']) -> None:
        ...
