...
#ifndef GOOGLE_PROTOBUF_INCLUDED_state_2fssl_5fgc_5freferee_5fmessage_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_state_2fssl_5fgc_5freferee_5fmessage_2eproto
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_state_2fssl_5fgc_5freferee_5fmessage_2eproto;
...
constexpr HullColor HullColor_MIN = HULL_COLOR_UNKNOWN;
constexpr HullColor HullColor_MAX = HULL_COLOR_LIGHT;
constexpr int HullColor_ARRAYSIZE = HullColor_MAX + 1;

const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* HullColor_descriptor();
template<typename T>
inline const std::string& HullColor_Name(T enum_t_value) {
  static_assert(::std::is_same<T, HullColor>::value ||
    ::std::is_integral<T>::value,
    "Incorrect type passed to function HullColor_Name.");
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    HullColor_descriptor(), enum_t_value);
}
inline bool HullColor_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, HullColor* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<HullColor>(
    HullColor_descriptor(), name, value);
}
// ===================================================================
...
// optional .HullColor hull_color = 19;
inline bool Referee_TeamInfo::_internal_has_hull_color() const {
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void Referee::set_status_message(ArgT0&& arg0, ArgT... args) {
 _impl_._has_bits_[0] |= 0x00000002u;
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void GameEventProposalGroup::set_id(ArgT0&& arg0, ArgT... args) {
 _impl_._has_bits_[0] |= 0x00000001u;
...
template <> struct is_proto_enum< ::HullColor> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::HullColor>() {
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_state_2fssl_5fgc_5freferee_5fmessage_2eproto
