...
#ifndef GOOGLE_PROTOBUF_INCLUDED_state_2fssl_5fgc_5fstate_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_state_2fssl_5fgc_5fstate_2eproto
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_state_2fssl_5fgc_5fstate_2eproto;
class Command;
...
class TeamInfo final :
 ...
 public:
  ...
  PROTOBUF_NODISCARD ::PROTOBUF_NAMESPACE_ID::Duration* release_bot_substitution_time_left();
  ...
  int32_t bot_substitutions_left() const;
...
class State final :
 ...
 public:
  ...
  PROTOBUF_NODISCARD ::PROTOBUF_NAMESPACE_ID::Timestamp* release_ready_continue_time();
  ...
  PROTOBUF_NODISCARD ::ShootoutState* release_shootout_state();
  ...
  int32_t max_bots_per_team() const;
...
public:
  ...
  explicit PROTOBUF_CONSTEXPR ShootoutState_NumberOfAttemptsEntry_DoNotUse(
      ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  explicit ShootoutState_NumberOfAttemptsEntry_DoNotUse(::PROTOBUF_NAMESPACE_ID::Arena* arena);
...
class ShootoutState final :
 ...
 public:
  ...
  ~ShootoutState() override;
  explicit PROTOBUF_CONSTEXPR ShootoutState(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  ShootoutState* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  void MergeFrom( const ShootoutState& from) {
    ShootoutState::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
 ...
 private:
  ...
  struct Impl_ {
    ...
    ::PROTOBUF_NAMESPACE_ID::internal::MapField<
        ...
        std::string, int32_t,
        ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::TYPE_STRING,
        ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::TYPE_INT32> number_of_attempts_;
    int next_team_;
  };
  union { Impl_ _impl_; };
  friend struct ::TableStruct_state_2fssl_5fgc_5fstate_2eproto;
...
void ProposalGroup::set_id(ArgT0&& arg0, ArgT... args) {
 _impl_._has_bits_[0] |= 0x00000001u;
...
inline const ::PROTOBUF_NAMESPACE_ID::Duration& TeamInfo::_internal_bot_substitution_time_left() const {
  const ::PROTOBUF_NAMESPACE_ID::Duration* p = _impl_.bot_substitution_time_left_;
  return p != nullptr ? *p : reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Duration&>(
      ::PROTOBUF_NAMESPACE_ID::_Duration_default_instance_);
}
...
inline void TeamInfo::unsafe_arena_set_allocated_bot_substitution_time_left(
    ::PROTOBUF_NAMESPACE_ID::Duration* bot_substitution_time_left) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.bot_substitution_time_left_);
  }
  _impl_.bot_substitution_time_left_ = bot_substitution_time_left;
...
inline ::PROTOBUF_NAMESPACE_ID::Duration* TeamInfo::release_bot_substitution_time_left() {
  _impl_._has_bits_[0] &= ~0x00000020u;
  ::PROTOBUF_NAMESPACE_ID::Duration* temp = _impl_.bot_substitution_time_left_;
...
inline ::PROTOBUF_NAMESPACE_ID::Duration* TeamInfo::_internal_mutable_bot_substitution_time_left() {
  ...
  if (_impl_.bot_substitution_time_left_ == nullptr) {
    auto* p = CreateMaybeMessage<::PROTOBUF_NAMESPACE_ID::Duration>(GetArenaForAllocation());
    _impl_.bot_substitution_time_left_ = p;
  }
...
inline ::PROTOBUF_NAMESPACE_ID::Duration* TeamInfo::mutable_bot_substitution_time_left() {
  ::PROTOBUF_NAMESPACE_ID::Duration* _msg = _internal_mutable_bot_substitution_time_left();
...
inline void TeamInfo::set_allocated_bot_substitution_time_left(::PROTOBUF_NAMESPACE_ID::Duration* bot_substitution_time_left) {
  ...
  if (bot_substitution_time_left) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalGetOwningArena(
                reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(bot_substitution_time_left));
    if (message_arena != submessage_arena) {
...
// optional .HullColor hull_color = 21;
inline bool TeamInfo::_internal_has_hull_color() const {
...
inline const ::PROTOBUF_NAMESPACE_ID::Timestamp& State::_internal_ready_continue_time() const {
  const ::PROTOBUF_NAMESPACE_ID::Timestamp* p = _impl_.ready_continue_time_;
  return p != nullptr ? *p : reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Timestamp&>(
      ::PROTOBUF_NAMESPACE_ID::_Timestamp_default_instance_);
}
...
inline void State::unsafe_arena_set_allocated_ready_continue_time(
    ::PROTOBUF_NAMESPACE_ID::Timestamp* ready_continue_time) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.ready_continue_time_);
  }
  _impl_.ready_continue_time_ = ready_continue_time;
...
inline ::PROTOBUF_NAMESPACE_ID::Timestamp* State::release_ready_continue_time() {
  _impl_._has_bits_[0] &= ~0x00000200u;
  ::PROTOBUF_NAMESPACE_ID::Timestamp* temp = _impl_.ready_continue_time_;
...
inline void State::set_allocated_ready_continue_time(::PROTOBUF_NAMESPACE_ID::Timestamp* ready_continue_time) {
  ...
  if (ready_continue_time) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalGetOwningArena(
                reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(ready_continue_time));
    if (message_arena != submessage_arena) {
...
inline void State::unsafe_arena_set_allocated_shootout_state(
    ::ShootoutState* shootout_state) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.shootout_state_);
  }
  _impl_.shootout_state_ = shootout_state;
  if (shootout_state) {
    _impl_._has_bits_[0] |= 0x00000400u;
  } else {
    _impl_._has_bits_[0] &= ~0x00000400u;
...
inline ::ShootoutState* State::_internal_mutable_shootout_state() {
  ...
  if (_impl_.shootout_state_ == nullptr) {
    auto* p = CreateMaybeMessage<::ShootoutState>(GetArenaForAllocation());
    _impl_.shootout_state_ = p;
  }
...
inline void State::set_allocated_shootout_state(::ShootoutState* shootout_state) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete _impl_.shootout_state_;
  }
  if (shootout_state) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalGetOwningArena(shootout_state);
    if (message_arena != submessage_arena) {
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void State::set_status_message(ArgT0&& arg0, ArgT... args) {
 _impl_._has_bits_[0] |= 0x00000001u;
...
inline int ShootoutState::_internal_number_of_attempts_size() const {
  return _impl_.number_of_attempts_.size();
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_state_2fssl_5fgc_5fstate_2eproto
