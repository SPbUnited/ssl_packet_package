...
#ifndef GOOGLE_PROTOBUF_INCLUDED_grsim_2fgrSim_5fRobotstatus_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_grsim_2fgrSim_5fRobotstatus_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_grsim_2fgrSim_5fRobotstatus_2eproto
...
struct TableStruct_grsim_2fgrSim_5fRobotstatus_2eproto {
  static const uint32_t offsets[];
};
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_grsim_2fgrSim_5fRobotstatus_2eproto;
class Robot_Status;
...
class Robots_Status final :
 ...
 public:
  ...
  ~Robots_Status() override;
  explicit PROTOBUF_CONSTEXPR Robots_Status(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  Robots_Status* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  void MergeFrom( const Robots_Status& from) {
    Robots_Status::MergeImpl(*this, from);
  }
  private:
 ...
 private:
  ...
  union { Impl_ _impl_; };
  friend struct ::TableStruct_grsim_2fgrSim_5fRobotstatus_2eproto;
};
// -------------------------------------------------------------------

class Robot_Status final :
 ...
 public:
  ...
  ~Robot_Status() override;
  explicit PROTOBUF_CONSTEXPR Robot_Status(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  Robot_Status* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  void MergeFrom( const Robot_Status& from) {
    Robot_Status::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
...
inline int Robots_Status::_internal_robots_status_size() const {
  return _impl_.robots_status_.size();
}
...
inline ::Robot_Status* Robots_Status::mutable_robots_status(int index) {
  ...
  return _impl_.robots_status_.Mutable(index);
}
...
inline const ::Robot_Status& Robots_Status::_internal_robots_status(int index) const {
  return _impl_.robots_status_.Get(index);
}
...
inline ::Robot_Status* Robots_Status::_internal_add_robots_status() {
  return _impl_.robots_status_.Add();
}
inline ::Robot_Status* Robots_Status::add_robots_status() {
  ::Robot_Status* _add = _internal_add_robots_status();
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_grsim_2fgrSim_5fRobotstatus_2eproto
